...
export default function TermsAndConditions() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <Head>
        <title>Terms and Conditions - EmojiExplorer.site</title>
        <meta name="description" content="Terms and Conditions for EmojiExplorer.site" />
      </Head>

      <main className="prose prose-lg">
        <h1 className="text-3xl font-bold mb-6">Terms and Conditions</h1>
        
        <h2 className="text-2xl font-bold mt-8 mb-4">Terms and Conditions for EmojiExplorer.site</h2>
        <p>
          Welcome to Emojiexplorer.site ("Site"). These Terms and Conditions ("Terms") govern your use of the Site and its services, including accessing, browsing, and using our emoji selection tools.
        </p>
        ...
        <p>Emojiexplorer.site provides a service allowing users to:</p>
        ...
        <p>You agree to use Emojiexplorer.site only for lawful purposes and in a way that does not:</p>
        <ul className="list-disc pl-6 mt-2">
          <li>Infringe on the intellectual property or other rights of Emojiexplorer.site or third parties.</li>
        ...
        <p>
          Emojiexplorer.site is provided "as is" without any warranties. We disclaim all express and implied warranties, including those of merchantability, fitness for a particular purpose, and non-infringement. We do not guarantee uninterrupted or error-free operation of the site.
        </p>
        
        <h2 className="text-2xl font-bold mt-8 mb-4">Limitation of Liability</h2>
        <p>
          Emojiexplorer.site is not liable for any direct, indirect, incidental, special, or consequential damages resulting from your use of the site, including lost profits or business interruptions.
        </p>
        ...
        <p>
          If you have any questions regarding these Terms, please contact us at <a href="mailto:support@emojiexplorer.site">support@emojiexplorer.site</a>.
        </p>
